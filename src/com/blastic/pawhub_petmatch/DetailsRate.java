...
public class DetailsRate extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Jal� las mismas mascotas en global, my rates y en top20Category, si se jala el id de la actividad
		 * pasada no hay informaci�n al menos q el idPet y la cat coincidan:
		 * 
		 ...
		 * no s� si sea porque las que si jalan info tienen [{" antes y �stas no jajajaja
		 */
