...
public class ListViewTopCategoryAdapter extends ArrayAdapter<TopCategory> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			view.findViewById(R.id.rowlayoutContainer)
					.getBackground()
		...
		if (holder.lblPetNameRates != null && null != topCat.getName()
			...
			SpannableString text = new SpannableString("Top 20 Most "
					+ topCat.getName());
			text.setSpan(new ForegroundColorSpan(Color.rgb(152, 30, 72)), 7,
					text.length(), 0);
			holder.lblPetNameRates.setText(text, BufferType.SPANNABLE);

			// holder.lblPetNameRates.setText("Top 20 More " +
			// topCat.getName());
		}
			...
			if (idCategoria != 0) {
				view.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						Intent intent = new Intent(context, Top20Category.class)
